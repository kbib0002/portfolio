...
export default function Projects() {
    return (
        <section id="projects" className="mb-32 md:mb-48 flex flex-col container w-[80%] mx-auto">
                    ...
                    <div>
                        <MagicCard className="rounded-lg">
                            <div className="p-8 space-y-8">
                                <div className="flex justify-between border-b pb-8">
                                    <span className="text-sm font-bold  sm:text-xl lg:text-2xl">Labour Allocation System</span>
                                    <span className="text-sm font-bold  sm:text-xl lg:text-2xl text-right text-muted-foreground">University Project</span>
                                </div>
                     ...
                     <div>
                        <MagicCard className="rounded-lg">
                            <div className="p-8 space-y-8">
                                <div className="flex justify-between border-b pb-8">
                                    <span className="text-sm font-bold  sm:text-xl lg:text-2xl">Behind the Veil</span>
                                    <span className="text-sm font-bold  sm:text-xl lg:text-2xl text-right text-muted-foreground">University Project</span>
                                </div>
                                <p className="text-muted-foreground text-xs sm:text-sm md:text-base">
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <div>
                                        <a href="https://github.com/Monash-FIT3170/Behind-The-Veil" target="_blank">
                                            <Button className="text-xs sm:text-sm md:text-base" variant="link">view project<ExternalLink/></Button>
                                        </a>
                                    </div>
                                </div>
                            </div>
