...
import OrbitingText from "@/components/orbiting-text";
import { MapPin, Mail } from "lucide-react";

export default function Hero() {
    return (
        <section id="hero" className="min-h-screen container mx-auto flex items-center justify-center w-[80%] max-w-6xl px-4">
