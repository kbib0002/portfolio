...
export default function Community() {
    return (
        <section id="community" className="min-h-screen mb-32 flex flex-col container w-[80%] mx-auto">
            ...
            <div className="mt-16 flex lg:w-[90%] mx-auto">
                <div className="flex flex-col w-full space-y-16 md:space-y-32 lg:space-y-16">
                    <div className="lg:flex gap-8">
                        <div className="lg:w-[50%] p-4 flex items-center">
                            <div className="columns-2 gap-4 space-y-4">
                                <picture><img className="mb-4 rounded-lg w-full h-auto" src="./whc1.jpg" alt="whc 1" width={500} height={500}/></picture>
                                <picture><img className="rounded-lg w-full h-auto" src="./whc2.jpg" alt="whc 2" width={500} height={500}/></picture>
                                <picture><img className="mb-4 rounded-lg w-full h-auto" src="./whc4.jpg" alt="whc 4" width={500} height={500}/></picture>
                        ...
                        <div className="lg:w-[50%] flex items-center">
                            <MagicCard className="rounded-lg">
                                <div className="p-8 space-y-8">
                                    <p className="font-bold  sm:text-xl lg:text-2xl">Waverley Hockey Club</p>
                        ...
                        <div className="lg:w-[50%] flex items-center">
                            <MagicCard className="rounded-lg">
                                <div className="p-8 space-y-8 text-right">
                                    <p className="font-bold  sm:text-xl lg:text-2xl">Bobby&#39;s Coaching Academy</p>
                                    <p className="text-muted-foreground text-xs sm:text-sm md:text-base">
                    ...
                    <div className="lg:flex gap-8">
                        <div className="lg:w-[50%] p-4 flex items-center">
                            <div className="gap-4 space-y-4 w-full">
                                <picture><img className="mb-4 rounded-lg w-full h-auto" src="./run1.jpg" alt="run 1" width={500} height={500}/></picture>
                        ...
                        <div className="lg:w-[50%] flex items-center">
                            <MagicCard className="rounded-lg">
                                <div className="p-8 space-y-8">
                                    <p className="font-bold  sm:text-xl lg:text-2xl">Athletics</p>
                                    <p className="text-muted-foreground text-xs sm:text-sm md:text-base">
